...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of MVoIP in Markdown format.
  ...
  s.author             = { "MiaoGuangfa" => "miaoguangfa@rongcloud.cn" }
  # Or just: s.author    = "MiaoGuangfa"
  # s.authors            = { "MiaoGuangfa" => "miaoguangfa@feinno.com" }
  s.social_media_url   = "http://weibo.com/2060062133/profile?topnav=1&wvr=6"
  ...
  # s.resource  = "icon.png"
  s.resources = "RongCloudSDK/RongCloud.bundle/*.png"
